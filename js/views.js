...
<nav class="page-nav" id="pageNav">
    ...
    <footer class="app-version">v38.19</footer>
  `,
  init: () => { HomeView_init(); },
  ...
  html: () => `
    <div id="editorShell">
      ...
      <div id="edTopbar">
        ...
        <!-- DIAGNÓSTICO TEMPORAL v38.19 — reactivado para capturar la pila de
             llamadas de escrituras a x/y (ver _mpInstrumentXY en editor.js).
             Volver a comentar esta línea en cuanto se identifique la causa. -->
      ...
      <div id="edDrawBar">
        ...
        <div class="edb-content">
          ...
          <div class="edb-sep"></div>
          <button id="edb-undo"   class="edb-tool" data-i18n-title="td_undo" title="Deshacer">↩</button>
          <button id="edb-redo"   class="edb-tool" data-i18n-title="td_redo" title="Rehacer">↪</button>
      ...
      <div id="edShapeBar">
        ...
        <div class="edb-content">
          ...
          <div class="edb-sep"></div>
          <button id="esb-undo"     class="edb-tool" data-i18n-title="td_undo" title="Deshacer">↩</button>
          <button id="esb-redo"     class="edb-tool" data-i18n-title="td_redo" title="Rehacer">↪</button>
