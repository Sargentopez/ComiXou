...
<nav class="page-nav" id="pageNav">
    ...
    <footer class="app-version">v36.27</footer>
  `,
  init: () => { HomeView_init(); },
    ...
    <div id="editorShell">
      ...
      <div id="edDrawBar">
        ...
        <div class="edb-content">
          ...
          <button id="edb-pen-size"    class="edb-tool edb-sizebtn-fix" data-i18n-title="ed_penThickness" title="Grosor lápiz" style="font-size:.7rem;font-weight:900">Ø</button>
          <button id="edb-eraser-size" class="edb-tool edb-sizebtn-fix" data-i18n-title="ed_eraserThickness" title="Grosor goma"   style="font-size:.7rem;font-weight:900;display:none">Ø</button>
          <div class="edb-sep"></div>
